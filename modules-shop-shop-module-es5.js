...
var ProductsViewComponent = /** @class */ (function () {
    function ProductsViewComponent(apiservice, sidebar) {
    ...
    ProductsViewComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.apiservice.getshopproducts(this.shop_id).subscribe(function (response) {
...
var ShopSidebarComponent = /** @class */ (function () {
    function ShopSidebarComponent(sidebar, platformId, apiservice) {
        this.sidebar = sidebar;
    ...
    ShopSidebarComponent.prototype.fetchNewProduct = function () {
        var _this = this;
        this.apiservice.getLastestProduct(5).subscribe(function (response) {
            _this.products = response.data.slice();
        }, function (err) { return _this.error = err; });
    };
    ShopSidebarComponent.prototype.getDatetime = function (t) {
        if (!t) {
            return '';
        }
    ...
    ShopSidebarComponent.prototype.ngOnInit = function () {
        ...
        this.sidebar.isOpen$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["takeUntil"])(this.destroy$)).subscribe(function (isOpen) {
            if (isOpen) {
                _this.open();
            }
            else {
        ...
        if (Object(_angular_common__WEBPACK_IMPORTED_MODULE_6__["isPlatformBrowser"])(this.platformId)) {
            Object(_shared_functions_rxjs_fromMatchMedia__WEBPACK_IMPORTED_MODULE_5__["fromMatchMedia"])('(max-width: 991px)').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["takeUntil"])(this.destroy$)).subscribe(function (media) {
    ...
    ShopSidebarComponent.prototype.getImageUrl = function (uri) {
        if (!uri) {
...
var ShopsViewComponent = /** @class */ (function () {
    // fetchShop() {
    ...
    //   );
    // }
    function ShopsViewComponent(sidebar, shopService) {
        this.sidebar = sidebar;
    ...
    ShopsViewComponent.prototype.setLayout = function (value) {
        this.layout = value;
    };
    ShopsViewComponent.prototype.onPageChange = function (page) {
        // console.log(page);
    };
    ShopsViewComponent.ctorParameters = function () { return [
...
var PageCartComponent = /** @class */ (function () {
    function PageCartComponent(root, cart, authenService, apiService) {
        this.root = root;
        this.cart = cart;
    ...
    PageCartComponent.prototype.fetchCart = function () {
        var _this = this;
        var citizenId = this.authenService.currentUserValue.authority_info.CitizenId;
        this.apiService.getcart(citizenId).subscribe(function (response) {
            // Sort by shopid
            response.data.sort(function (c1, c2) {
            ...
            response.data.forEach(function (c) {
                if (c.Product.Shop.shop_id !== lastShopId) {
                    _this.groupedItems.push([]);
                }
                var lastIdx = _this.groupedItems.length - 1;
                _this.groupedItems[lastIdx].push({
                    cartItem: c,
    ...
    PageCartComponent.prototype.getImageUrl = function (uri) {
        if (!uri) {
            return '/assets/images/na.jpg';
        }
        return 'https://market.aniccom.com' + uri;
    ...
    PageCartComponent.prototype.remove = function (item) {
        ...
        // api remove
        this.apiService.removecart(item.cart_id).subscribe(function (response) {
            _this.cart.remove(item).subscribe({
                complete: function () {
                    _this.fetchCart();
                    _this.removedItems = _this.removedItems.filter(function (eachItem) { return eachItem !== item; });
                }
            });
        }, function (err) { return _this.error = err; });
    };
...
var PageCategoryComponent = /** @class */ (function () {
    function PageCategoryComponent(route, apiservice) {
        var _this = this;
        this.route = route;
        this.apiservice = apiservice;
    ...
    PageCategoryComponent.prototype.fetchCategory = function () {
        var _this = this;
    ...
    PageCategoryComponent.prototype.ngOnInit = function () {
        var _this = this;
        var shopId = this.route.snapshot.paramMap.get('id');
        this.apiservice.getshop(shopId).subscribe(function (response) {
...
var PageMapComponent = /** @class */ (function () {
    function PageMapComponent() {
    }
...
var PageOrderStatusComponent = /** @class */ (function () {
    function PageOrderStatusComponent(root, cart, modalService) {
        this.root = root;
        this.cart = cart;
    ...
    PageOrderStatusComponent.prototype.ngOnInit = function () {
        // this.cart.items$.pipe(
        //     takeUntil(this.destroy$),
        //     map(cartItems => cartItems.map(cartItem => {
        //         return {
    ...
    PageOrderStatusComponent.prototype.ngOnDestroy = function () {
        this.destroy$.next();
        this.destroy$.complete();
    };
    PageOrderStatusComponent.prototype.remove = function (item) {
        if (this.removedItems.includes(item)) {
            return;
        }
        // this.removedItems.push(item);
    ...
    PageOrderStatusComponent.prototype.update = function () {
        // this.updating = true;
        // this.cart.update(
        //     this.items
        //         .filter(item => item.quantityControl.value !== item.quantity)
    ...
    PageOrderStatusComponent.prototype.needUpdate = function () {
        var needUpdate = false;
    ...
    PageOrderStatusComponent.prototype.showMapShopModal = function (template, item) {
        this.mapShopModalRef = this.modalService.show(template);
    };
    PageOrderStatusComponent.prototype.showReviewShopModal = function (template, item) {
        this.reviewShopModalRef = this.modalService.show(template);
    };
    PageOrderStatusComponent.ctorParameters = function () { return [
        { type: _shared_services_root_service__WEBPACK_IMPORTED_MODULE_5__["RootService"] },
        { type: _shared_services_cart_service__WEBPACK_IMPORTED_MODULE_3__["CartService"] },
    ...
    return PageOrderStatusComponent;
}());
...
var PageProductComponent = /** @class */ (function () {
    function PageProductComponent(route, productService) {
        var _this = this;
        this.route = route;
    ...
    PageProductComponent.prototype.fetchRelatedProducts = function () {
        var _this = this;
        this.productService.getPopular().subscribe(function (data) {
            setTimeout(function () {
                _this.products = data.slice();
            }, 1000);
        }, // success path
    ...
    PageProductComponent.prototype.fetchProduct = function (id) {
        var _this = this;
        this.productService.getSingleData(id).subscribe(function (data) {
            setTimeout(function () {
                _this.product = data;
            }, 1000);
        }, // success path
...
var PageShopCategoryComponent = /** @class */ (function () {
    function PageShopCategoryComponent(apiservice, route) {
        var _this = this;
        this.apiservice = apiservice;
        this.route = route;
        this.shops = _data_shops_list__WEBPACK_IMPORTED_MODULE_2__["shops"];
    ...
    PageShopCategoryComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.keyword = this.route.snapshot.queryParamMap.get('search');
        this.category = this.route.snapshot.queryParamMap.get('category');
        if (this.category) {
            this.apiservice.searchShopByCategory(this.category).subscribe(function (response) {
                _this.shops = response.data.slice();
                console.log(_this.shops);
            }, function (err) { return _this.error = err; });
        }
        else if (this.keyword) {
            this.apiservice.searchShopByKeyword(this.keyword).subscribe(function (response) {
                _this.shops = response.data.slice();
                console.log(_this.shops);
            }, function (err) { return _this.error = err; });
        }
    };
    PageShopCategoryComponent.ctorParameters = function () { return [
        { type: src_app_shared_services_api_service__WEBPACK_IMPORTED_MODULE_5__["ApiService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] }
    ]; };
    ...
    return PageShopCategoryComponent;
}());
...
var PageWishlistComponent = /** @class */ (function () {
    function PageWishlistComponent(root, wishlist, cart, authenService, apiService) {
        this.root = root;
    ...
    PageWishlistComponent.prototype.getImageUrl = function (uri) {
        if (!uri) {
            return '/assets/images/na.jpg';
        }
        return 'https://market.aniccom.com' + uri;
    };
    PageWishlistComponent.prototype.fetchWishList = function () {
        var _this = this;
        var citizenId = this.authenService.currentUserValue.authority_info.CitizenId;
        this.apiService.getwishlist(citizenId).subscribe(function (response) {
            _this.allWishlist = response.data.slice();
            console.log("-----------------");
            console.log(_this.allWishlist);
        }, function (err) { return _this.error = err; });
    };
    PageWishlistComponent.prototype.addToCart = function (product) {
        ...
        // Api add cart
        var citizenId = this.authenService.currentUserValue.authority_info.CitizenId;
        this.apiService.addCart(citizenId, product.product_id, 1).subscribe(function (response) { }, function (err) { return _this.error = err; });
        this.addedToCartProducts.push(product);
        //this.cart.add(product, 1).subscribe({
        //complete: () => {
        this.addedToCartProducts = this.addedToCartProducts.filter(function (eachProduct) { return eachProduct !== product; });
        //}
        //});
    };
    PageWishlistComponent.prototype.remove = function (product, w_id) {
        var _this = this;
        if (this.removedProducts.includes(product)) {
            return;
        }
        this.removedProducts.push(product);
        // Api remove wishlist
        this.apiService.removeWishlist(w_id).subscribe(function (response) {
            _this.wishlist.remove(product).subscribe({
                complete: function () {
                    _this.fetchWishList();
                    _this.removedProducts = _this.removedProducts.filter(function (eachProduct) { return eachProduct !== product; });
                }
...
var ShopService = /** @class */ (function () {
    ...
    ShopService.prototype.getSingleData = function (id) {
        return this.http.get(this.dataUrl + '/' + id)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["retry"])(3), // retry a failed request up to 3 times
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError) // then handle the error
        );
    };
    ShopService.prototype.postData = function (shop) {
        return this.http.post(this.dataUrl, shop)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["retry"])(3), // retry a failed request up to 3 times
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError) // then handle the error
        );
    };
    ShopService.prototype.putData = function (shop) {
        return this.http.put(this.dataUrl + '/' + shop.shop_id.toString(), shop)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["retry"])(3), // retry a failed request up to 3 times
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError) // then handle the error
        );
    };
    ShopService.prototype.deleteData = function (id) {
